function init() {
  ...
  function buildCharts(sample) {
    ...
    d3.json("samples.json").then((data) => {
      ...
      var wfreq = MetadataArray.filter(sampleObj => sampleObj.id == sample)[0].wfreq;
      ...
      var bubbleLayout = {
          title: "Bacteria Cultures Per Sampel",
          showlegend: false,
          xaxis: {
              title : "OTU ID"
          },   
...
// 5. Create the layout for the gauge chart.
    var gaugeLayout = { width:600, height:540, margin: {t:0,b:0}};
